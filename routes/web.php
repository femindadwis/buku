...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::delete('/user/destroy/{id}', [UserController::class, 'destroy'])->middleware(['admin'])->name('user.destroy');
    ...
    // Route::delete('/penerbit/destroy/{id}', [PenerbitController::class, 'destroy'])->middleware(['admin'])->name('penerbit.destroy');
    ...
    // Route::delete('/buku/destroy/{id}', [BukuController::class, 'destroy'])->middleware(['user'])->name('buku.destroy');
